...
function NewOrder({onClick}) {
  return (
    <div className="w-screen md:w-[489px] bg-white p-5 md:ml-auto shadow-2xl">
      <div className="text-end">
        <CloseIcon onClick={onClick} style={{cursor:'pointer'}}/>
      </div>
      <div className="px-10 pt-5 font-bold md:text-2xl text-center">
        Order Information
      </div>
        ...
        <div className="flex items-end justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="md:space-y-2">
              <div className="font-semibold text-[13px] md:text-[17px]">
                Veg Pizza (Medium)
              </div>
              <div className="text-[10px] md:text-[13px] text-gray-400 font-semibold">1X</div>
              <div className="text-[11px] md:text-[13px] text-gray-400 font-semibold">
                Add extra cheese
              </div>
            </div>
          </div>
          <div className="text-md md:text-xl font-bold">₹ 100</div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-x-2 gap-y-2 my-4">
        <button className="bg-yellow-400 text-black text-[12px] md:text-[16px] p-2 rounded-md">
          <AddIcon style={{ fontSize: '1rem' }}/> Add Items
        </button>
        <button className="bg-blue-500 text-white text-[12px] md:text-[16px] p-2 rounded-md">
          <PrintIcon style={{ fontSize: '1rem' }} /> Print KOT
        </button>
        <button className="bg-gray-500 text-white text-[12px] md:text-[16px] p-2 rounded-md">
          <PrintIcon style={{ fontSize: '1rem' }} /> Print Invoice
        </button>
        <button className="bg-green-700 text-white text-[12px] md:text-[16px] p-2 rounded-md">
          Pay Later
        </button>
      </div>

      <div className="text-sm md:text-lg my-4">Write Instructions</div>
